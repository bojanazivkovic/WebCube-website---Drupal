        ...
        <div id="kontakt" class="contact">
            <div class="section primary-section">
                <div class="container">
				 ...
				 <div class="container">
                        <div class="row-fluid">
						<div class="span7 contact-form left">
						...
						<div class="span5 right contact-info">
								<p class="logoIme"><strong style="color:#ee3e34"> <?php print $site_name; ?>   </strong></p>
								
								<?php $contact_mail = theme_get_setting('contact_mail');?>
								<p class="info-mail"> <?php print $contact_mail;?></p>
								<br>
								<?php $contact_phone = theme_get_setting('contact_phone');?>
								<p> <?php print $contact_phone;?></p>
								
								<ul class="social">
                            <li>
							<?php $facebook_url = theme_get_setting('facebook_url');?>
                                <a href="<?php print $facebook_url;?>">
                                    <span class="icon-facebook-circled"></span>
                                </a>
                            </li>
                            <li>
							<?php $twitter_url = theme_get_setting('twitter_url');?>
                                <a href="<?php print $twitter_url;?>">
