...
<?php 
	$fid = theme_get_setting('background_front');						
						if ($fid){							
							$background_front = file_create_url(file_load($fid)->uri); 
						}else{
							$background_front = drupal_get_path('theme', 'webcube') . "/images/background.png"; //za front page ne treba base_path() posto drupal zna gde se nalazi :-)
						}
?>

<body style="background: url(<?php echo $background_front; ?>) no-repeat center center fixed; -webkit-background-size: cover; background-size: cover;">
